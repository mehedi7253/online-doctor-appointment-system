        ...
        <div class="main-content">
          ...
          ";
                                ...
                                <div class="box-header with-border">
                                    <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#addnew"><i class="fa fa-plus"></i> Add New Psychologists</button>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                        ...
                                        <tbody>
                                        <?php
                                        $sql = "SELECT * FROM doctors WHERE category = 'psychologist'";
                ...
                <form action="add_query.php" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6 col-sm-12 float-left">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" hidden value="psychologist" name="category">
                    ...
                    <div class="form-group col-md-6 float-left">
                        ...
                        <div class="input-group">
                            <button type="submit" class="btn btn-primary btn-flat btn-block" name="add_psychologist"><i class="fa fa-save"></i> Add New Psychologists</button>
                        </div>
                    </div>
                </form>
            </div>
