        ...
        <div class="main-content">
          ...
          ";
                                ...
                                <div class="box-header with-border">
                                    <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#addnew"><i class="fa fa-plus"></i> Add New Physical Trainer</button>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                                        ...
                                        <tbody>
                                        <?php
                                        $sql = "SELECT * FROM doctors WHERE category = 'trainer'";
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="formModal">Add New Physical Trainer </h5>
                ...
                <form action="add_query.php" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6 col-sm-12 float-left">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" hidden value="trainer" name="category">
                    ...
                    <div class="form-group col-md-6 col-sm-12 float-left">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" placeholder="Doctor Type" name="types">
                        </div>
                    </div>
                    <!--                    <div class="form-group col-md-6 col-sm-12 float-left">-->
                    ...
                    <div class="form-group col-md-6 float-left">
                        ...
                        <div class="input-group">
                            <button type="submit" class="btn btn-primary btn-flat btn-block" name="add_trainer"><i class="fa fa-save"></i> Add New Physical Trainer</button>
                        </div>
                    </div>
                </form>
            </div>
