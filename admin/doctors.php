        ...
        <div class="main-content">
          ...
          ";
                                ...
                                <div class="box-header with-border">
                                    <button type="button" class="btn btn-primary float-right" data-toggle="modal" data-target="#addnew"><i class="fa fa-plus"></i> Add New Doctor</button>
                                </div>
                ...
                <form action="add_query.php" method="post" enctype="multipart/form-data">
                    <div class="form-group col-md-6 col-sm-12 float-left">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" hidden value="doctor" name="category">
                    ...
                    <div class="form-group col-md-6 float-left">
                        ...
                        <div class="input-group">
                            <button type="submit" class="btn btn-primary btn-flat btn-block" name="add_doctor"><i class="fa fa-save"></i> Add New Doctor</button>
                        </div>
                    </div>
                </form>
            </div>
