                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                $sql_getData = "SELECT * FROM doctors, patient, appointment WHERE 
                                                ...
                                                doctors.doctor_id = '$userdata[doctor_id]' ORDER BY patient.patient_id";
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)){?>
                                            <tr class="text-center">
                                                ...
                                                <td style="border: 1px solid lightsteelblue">
                                                    <?php
                                                    $sql_payment = "SELECT * FROM appointment_invoice WHERE appointment_id = '$row[appoinment_id]' AND doctor_id = '$userdata[doctor_id]'";
                                                    $res_payment = mysqli_query($connect, $sql_payment);

                                                    $data = mysqli_fetch_assoc($res_payment);

                                                    if ($data !=0){
                                                        echo '<span class="btn btn-success">Payment Complete</span>';
                                                    }else{
                                                        echo '<a class="btn btn-primary text-white">Payment Not Complete</a>';
                                                    }
                                                    ?>
                                                </td>
                                                <td style="border: 1px solid lightsteelblue">
                                                    ...
                                                    if ($data !=0){
                                                        ...
                                                        echo '<span class="btn btn-danger">Payment Pending</span>';
                                                    }
                                                    ?>
