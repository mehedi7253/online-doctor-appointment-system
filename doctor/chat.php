                            ...
                            <div class="card-body">
                                <div class="card-body"  style="margin: 5px; padding: 5px; height: 400px; overflow: auto;">
                                    <p>
                                        ...
                                        $view_message =  "SELECT * FROM chat WHERE msg_id = '$message_id' AND to_id = '$userdata[doctor_id]'";
                            ...
                            <div class="card-footer">
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div  class="form-group input-group">
                                        ...
                                        <input type="number" name="to_id" hidden  value="<?php echo $userdata['doctor_id'];?>" class="form-control">
