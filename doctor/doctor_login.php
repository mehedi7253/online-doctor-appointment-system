            ...
            <div class="card card-primary">
             ...
             <div class="card-body">
                 ...
                 if (isset($_POST['login'])){
                     ...
                     $sql = "SELECT * FROM doctors WHERE email ='$email' AND password = '$has' AND category = '$category'";
                 ...
                 <form method="POST" action="" class="needs-validation" novalidate="">
                     <div class="form-group">
                         <label for="email">Plese Select One Category</label>
                         <select class="form-control" name="category" tabindex="1" required autofocus>
