                        ...
                        <div class="card">
                                ...
                                <div class="card-body"  style="margin: 5px; padding: 5px; height: 400px; overflow: auto;">
                                    <p>
                                        ...
                                        if (isset($_GET['chat_id'])){
                                            $message_id = $_GET['chat_id'];

                                            $get_type_id = "SELECT * FROM chat WHERE msg_id = $message_id";
                                        ...
                                        $view_message =  "SELECT * FROM chat WHERE msg_id = '$message_id' AND to_id = '$userdata[worker_id]'";
                            ...
                            <div class="card-footer">
                                ...
                                if (isset($_POST['btn'])){
                                    ...
                                    echo "<script>document.location.href='chat.php?chat_id=$message_id'</script>";
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div  class="form-group input-group">
                                        ...
                                        <input type="number" name="to_id" hidden  value="<?php echo $userdata['worker_id'];?>" class="form-control">
                                        <input type="number" name="msg_id"  hidden value="<?php echo $message_id;?>" class="form-control">
