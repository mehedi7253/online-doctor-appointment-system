                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="card-body"  style="margin: 5px; padding: 5px; height: 400px; overflow: auto;">
                                    <p>
                                        ...
                                        $view_message =  "SELECT * FROM chat WHERE msg_id = '$userdata[patient_id]' AND to_id = '$message_id' ORDER BY msg_id";
                            ...
                            <div class="card-footer">
                                ...
                                if (isset($_POST['btn'])){
                                    ...
                                    echo "<script>document.location.href='chat_box_ psychologist.php?message_id=$message_id'</script>";
