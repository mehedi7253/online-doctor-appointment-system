                            ...
                            <div class="card-body">
                                <nav>
                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                        ...
                                        <a class="nav-item nav-link bg-secondary" id="nav-trainer-tab" data-toggle="tab" href="#nav-trainer" role="tab" aria-controls="nav-trainer" aria-selected="false"> <span class="ml-3 text-white font-weight-bold"> Physical Trainer</span></a>
                                                ...
                                                <table class="table tab-bordered">
                                                    ...
                                                    <?php while ($row = mysqli_fetch_assoc($res_psychologist)){?>
                                                        <tr>
                                                            <td class="text-capitalize border-bottom"><?php echo $row['first_name'] . ' '. $row['last_name'];?></td>
                                                            <td class="text-capitalize border-bottom">
                                                                <a class="text-decoration-none" href="chat_box_nutrition.php?message_id=<?php echo $row['doctor_id'];?>">Message Now</a>
                                                            </td>
                                                            <td class="text-capitalize border-bottom"><i class="fas fa-circle" style="color: green"></i></td>
                                                        </tr>
                                                    <?php }?>
                                    ...
                                    <div class="tab-pane fade" id="nav-trainer" role="tabpanel" aria-labelledby="nav-trainer-tab">
                                        <div class="form_1 mt-4">
                                            <div class="table-responsive">
                                                <table class="table tab-bordered">
                                                    <?php
                                                    $sql_psychologist = "SELECT * FROM doctors WHERE category = 'trainer'";
                                                    $res_psychologist = mysqli_query($connect, $sql_psychologist);
                                                    ...
                                                    <?php while ($row = mysqli_fetch_assoc($res_psychologist)){?>
                                                        <tr>
                                                            <td class="text-capitalize border-bottom"><?php echo $row['first_name'] . ' '. $row['last_name'];?></td>
                                                            <td class="text-capitalize border-bottom">
                                                                <a class="text-decoration-none" href="chat_box_trianer.php?message_id=<?php echo $row['doctor_id'];?>">Message Now</a>
                                                            </td>
                                                            <td class="text-capitalize border-bottom"><i class="fas fa-circle" style="color: green"></i></td>
                                                        </tr>
                                                    <?php }?>
                                    ...
                                    <div class="tab-pane fade" id="nav-worker" role="tabpanel" aria-labelledby="nav-worker-tab">
                                        <div class="form_1 mt-4">
                                            <div class="table-responsive">
                                                <table class="table tab-bordered">
                                                    <?php
                                                        $sql_worker = "SELECT * FROM social_worker";
                                                        $res_worker = mysqli_query($connect, $sql_worker);

                                                    ?>

                                                    <?php while ($row = mysqli_fetch_assoc($res_worker)){?>
                                                        <tr>
                                                            <td class="text-capitalize border-bottom"><?php echo $row['first_name'] . ' '. $row['last_name'];?></td>
                                                            <td class="text-capitalize border-bottom">
