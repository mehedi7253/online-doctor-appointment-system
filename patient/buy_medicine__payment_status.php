                                            ...
                                            while ($row = mysqli_fetch_assoc($res)){?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        $sql22 = "SELECT * FROM payment_medicine WHERE med_invoice = '$row[med_invoice]'";
                                                        $res22 = mysqli_query($connect, $sql22);

                                                        $dd = mysqli_fetch_assoc($res22);

                                                       if ($dd !=0){
                                                           echo '<a class="btn btn-success btn-block text-dark font-weight-bold" disabled>Paid</a>';
                                                       }else{
                                                           echo '<a href="pay_medicine.php?med_invoice='.$row['med_invoice'].'" class="btn btn-primary btn-block text-white">Pay Now</a>';
                                                        }
                                                        ?>
                                                    </td>
                                                    <td>
                                                        ...
                                                        if ($d !=0){
                                                            echo '<a href="invoice.php?invoice_id='.$row['med_invoice'].'" class="btn btn-primary">View Invoice</a>';
                                                        }else{
