                        ...
                        <div class="card">
                                ...
                                <?php
                                    if (isset($_POST['btn'])){
                                        ...
                                        if ($user_id && $post_desc){
                                            ...
                                            $sql_post = "INSERT INTO social_feed (user_id, user_name, user_image, post_desc, date) VALUES ('$user_id', '$user_name', '$user_image', '$post_desc', '$create')";
                            ...
                            <div class="card-body">
                               <div class="col-md-8 col-sm-12 float-left">
                                   <div class="card-body"  style="margin: 5px; padding: 5px; height: 1000px; overflow: auto; border-right: 1px solid silver">
                                       <form action="" method="post">
                                           <div class="form-group col-md-12 col-sm-12">
                                               <input type="text" hidden name="user_id" value="<?php echo $userdata['patient_id'];?>">
                                       ...
                                       <div class="mt-2">
                                           <?php
                                               $get_post = "SELECT * FROM social_feed";
                                                       ...
                                                       <div class="card-footer">
                                                           ...
                                                           <form action="" method="post">
                                                               ...
                                                               <div class="form-group">
                                                                   ...
                                                                   <input type="text" hidden name="user_comment_id" value="<?php echo $userdata['patient_id'];?>">
                                ...
                                <div class="col-md-4 col-sm-12 float-left">
                                    <h6 class="mt-5">Contact With Social Worker</h6>

                                    <div class="table-responsive">
                                        <table class="table">
                                            <?php
                                                $sql_social_worker = "SELECT * FROM social_worker";
                                                $res_social_worker = mysqli_query($connect, $sql_social_worker);
                                            ?>

                                            <?php  while ($row = mysqli_fetch_assoc($res_social_worker)){?>
                                                <tr>
                                                    <td class="text-capitalize"><a href="social_worker_profile.php?id=<?php echo $row['worker_id'];?>" title="View Profile" class="text-decoration-none"><?php echo $row['first_name'] .' '.$row['last_name'];?></a></td>
                                                    <td><a href="chat_box_worker.php?message_id=<?php echo $row['worker_id'];?>" class="text-decoration-none">Message</a></td>
